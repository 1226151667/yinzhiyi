...
#back .tm{background: url("__PUBLIC__/images/551121af96d13.jpg");filter:alpha(opacity=80); -moz-opacity:0.8; opacity:0.8;}
...
<div class="jumbotron1 " id="help">
    <div class="container">  
        <div class="row">
        <!--left-->
            <div class="col-md-2 clearfix" id="tb"> 
                <table id="tb_1">
                    <tr>
                        <td style="width:50%;">
                ...
                <div id="tab">
                    ...
                    <ul id="tab_img">
                        ...
                        <li id="ownCustom">57576</li>
                    </ul>     
                </div>
            </div>
        <!-- /left -->
        <!-- center_视频 -->
            <!-- yy：http://yy.com/s/23614648/23614648/yyscene.swf -->
            <div class="col-md-6" id="sp_2">
                <div id="yyTop">
                    <ul>
                        <li class="laoshi">
                            <a id="laoshi">当前老师：</a>
...
<!--                                 <li>
                            ...
                            <?php
 $htm = ''; $now = date("Y-m-d"); foreach($chatList as $row){ if($row['toUserName']){ $toUserName = " 对 <span onclick='getToUser(this)' userType='".$row['toUserType']."' name='".$row['toUserId']."' class='userId'><img style='width:30px;height:30px;' src='".$row['toUserPic']."' />".$row['toUserName']."</span>"; }else{ $toUserName = ''; } $time = strtotime($row['tm']); $tm = date("H:i:s",$time); $htm .= "<span name='".$row['id']."' class='tm'>[".$tm."]</span>&nbsp;&nbsp;<span userType='".$row['userType']."' name='".$row['userId']."' class='userId'><img style='width:30px;height:30px;' src='".$row['userPic']."' />".$row['userName']."</span> ".$toUserName."<br /><br /><span class='content'>".$row['content']."</span><br /><br />"; } echo $htm; ?>
                        </div>
                        <div id="qq">
                    	   <ul class="clearfix">
                        	    <li>
            ...
            function(data){
                ...
                $(data).each(function(i,v){
                    ...
                    if(v.toUserName == ""){
                        ...
                        var toUserName = ' 对 <span onclick="getToUser(this)" userType="'+v.toUserType+'" name="'+v.toUserId+'" class="userId"><img style="height:30px;widht:30px;" src="'+v.toUserPic+'" />'+v.toUserName+'</span>';
                    }
                    htm0 = htm0+'<span name="'+v.id+'" class="tm">['+Tm+']</span>&nbsp;&nbsp;<span onclick="getToUser(this)" userType="'+v.userType+'" name="'+ v.userId +'" class="userId"><img style="height:30px;widht:30px;" src="'+v.userPic+'" />'+ v.userName +'</span>'+toUserName+'<br /><br /><span class="content">'+ v.content +'</span><br /><br />';
                    $("#back").append(htm0);
                    scroll();
                });
            },
