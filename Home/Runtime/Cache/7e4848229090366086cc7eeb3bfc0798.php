...
/***************轮播图**********************/
var Img = ['ls1.png','ls2.png','ls3.png','ls4.png','ls5.png','ls6.png'];
var igI = 0;
var lbImg = $(".lunbo");
function imgChange(){
    lbImg.attr("src","__PUBLIC__/images/"+Img[igI]);
    if(igI==5){
        igI=0;
    }else{
        igI++;
...
lbImg.mouseover(function(){
    clearInterval(lbSwf);
}).mouseout(function(){
    lbSwf = self.setInterval("imgChange()",2000);
});
var lbSwf = self.setInterval("imgChange()",2000);
/****************表情********************/
