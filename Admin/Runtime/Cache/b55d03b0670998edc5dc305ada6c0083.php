...
<div id="body-wrapper">
 ...
 foreach($list as $row){ ?>
	...
	<div id="log" class="subjectTable">
		...
		<form method="post" action="<?php echo U('Index/systemTable');?>" enctype="multipart/form-data">
...
$(function(){
	...
	$("button[class='all']").click(function(){
		window.location.href="<?php echo U('Index/systemTable');?>";
	});
	//添加or修改
