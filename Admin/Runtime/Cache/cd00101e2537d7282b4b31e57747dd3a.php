...
<div id="body-wrapper">
 ...
 foreach($list as $row){ ?>
	...
	<div id="log" class="subjectTable">
		...
		<form method="post" enctype="multipart/form-data" action="<?php echo U('Index/empUserType');?>">
...
$(function(){
	...
	$("button[class='all']").click(function(){
		window.location.href="<?php echo U('Index/empUserType');?>";
	});
	//添加or修改
